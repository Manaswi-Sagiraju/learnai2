...
**Repository Note**
This repository mainly contains the frontend implementation of the platform.
For reference purposes, some backend files have been included, but the full backend system and ML pipeline are not part of this repository.
